...
app.use("/api/v1", verificarToken, validarIP, productsRouter);
app.use("/api/v1", verificarToken, validarIP, categoryRouter);
app.use("/api/v1", verificarToken, validarIP, brandsRouters);
app.use("/api/v1", verificarToken, validarIP, modelsRouter);
app.use("/api/v1", verificarToken, validarIP, cilidRouters);
app.use("/api/v1", verificarToken, validarIP, transportRoutes);
app.use("/api/v1", verificarToken, validarIP, clientRoutes);
export default app;